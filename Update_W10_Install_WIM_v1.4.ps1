...
# Author:  Mike Marable
#
# Corrected minor typo in line 195
#     Original:  IF (Test-Path -path $TmpWinREImage) {Remove-Item -Path $TmpImage -Force}
#     Corrected: IF (Test-Path -path $TmpWinREImage) {Remove-Item -Path $TmpWinREImage -Force}
